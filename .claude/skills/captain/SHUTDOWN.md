...
| Context approaching limit (~80–90%); fleet still healthy | **Keeper-driven restart**: do NOT stop crews manually — the keeper handles the cycle. Skip to Step 5 (state capture). |
