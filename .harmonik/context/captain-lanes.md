...
## ⭐⭐ CURRENT TRUTH 2026-07-11 ~01:25Z — pi redeploy DECOUPLED from gate beads → GATE-0 e2e is the SOLE gate (operator 019f4ec1)
> **OPERATOR DIRECTIVE (event 019f4ec1, load-bearing):** the pi/flagship redeploy is NO LONGER gated on hk-x2spu + hk-ih5k6. The SOLE redeploy gate is now ONE isolated GATE-0 e2e test (repro pi hang on OLD binary d7abf34a → prove green with afa32372; doubles as root-cause confirmation). On GATE-0 green, captain redeploys on own authority.
