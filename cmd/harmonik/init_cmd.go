...
//
// The keeper: block is emitted FULLY COMMENTED. An absent value = the compiled
// default — so a third party does NOT inherit this operator's locked
// 200k/215k/240k band; they get whatever the compiled defaults are, and may
// uncomment any single line to override it. Each line is annotated with its
// compiled default (read from internal/keeper/thresholds.go).
...
# Spec refs: hk-9kgf (config schema), hk-vxn8 (this commented template).
#
# EVERY line below is COMMENTED OUT. An absent value = the COMPILED DEFAULT —
# so you do NOT inherit this operator's locked band; you get the compiled
# defaults annotated to the right of each key. Uncomment any single line to
# override exactly that one tunable (schema_version: 1 above keeps the version
# check happy when you do). Token/count fields are plain numbers; ALL duration
# fields are Go duration STRINGS ("5m", "120s") — a bare number is REJECTED.
# keeper:
#   context_thresholds:
#     warn_abs_tokens: 200000         # default: 200000   (absolute warn gate)
#     act_abs_tokens: 215000          # default: 215000   (absolute act gate)
#     force_act_abs_tokens: 240000    # default: 240000   (act + force_act_abs_offset; unconditional clear)
#     force_act_abs_offset: 25000     # default: 25000    (offset over act when force_act_abs_tokens unset)
#     idle_floor_abs_tokens: 150000   # default: 150000   (floor below which idle crews are not idle-restarted)
#     warn_pct_ceil: 0.70             # default: 0.70     (pct-of-window cap for warn gate; (0,1])
#     act_pct_ceil: 0.85              # default: 0.85     (pct-of-window cap for act gate; (0,1])
#   hard_ceiling:
#     mode: alarm                     # default: alarm    # off|alarm|restart
#     abs_tokens: 280000              # default: 280000   (SID-independent backstop)
#     cooldown: 5m                    # default: 5m       (Go duration string)
#   timings:
#     poll_interval: 5s               # default: 5s
#     idle_quiesce: 8s                # default: 8s
#     staleness: 2m                   # default: 2m
#     handoff_timeout: 3m             # default: 3m
#     clear_settle: 3s                # default: 3s
#     boot_grace: 5m                  # default: 5m
#     max_boot_grace_total: 10m       # default: 10m      (2 x boot_grace when unset)
#   cadence:
#     warn_cooldown: 30s              # default: 30s
#     no_gauge_backoff: 30s           # default: 30s
#     respawn_grace: 20s              # default: 20s
#     respawn_cooldown: 90s           # default: 90s
#     live_recover_grace: 5m          # default: 5m
#     live_recover_cooldown: 5m       # default: 5m
#     force_retry_interval: 2m        # default: 2m
#     idle_restart_cooldown: 30m      # default: 30m
#     hard_ceiling_cooldown: 5m       # default: 5m
#     blind_keeper_threshold: 5m      # default: 5m
#   budgets:
#     heartbeat_max_misses: 12        # default: 12
#     max_handoff_timeouts: 3         # default: 3
#   self_service:
#     enabled: true                   # default: false    (bool)
#     grace_seconds: 30               # default: 30
#     instruct_only_when_idle: true   # default: false    (bool)
#     crews_enabled: true             # default: true     (operator decision: crews self-restart by default)
#   warn_messages:
#     default_warn_text: ""           # default: "" -> compiled wrap-up advisory (non-captain agents)
#     on_demand_warn_text: ""         # default: "" -> compiled restart-now advisory (captain)
