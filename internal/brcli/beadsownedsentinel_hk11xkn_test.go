...
func hk11xknTempProject(t *testing.T) (adapter *brcli.Adapter, projectDir, intentLogDir string) {
	t.Helper()
	...
	//nolint:gosec // G306: executable test fixture requires owner execute permission.
