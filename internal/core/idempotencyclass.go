...
// DefaultIdempotencyClassForNodeRole returns the baseline idempotency-class
...
// encodes the static baseline. Later node types that register
...
// NodeRole constants; callers MUST check ok before using the class.
