...
// TestRunCompletedPayload_QueueFieldsOmittedWhenNil verifies that when QueueID
...
func TestRunCompletedPayload_QueueFieldsOmittedWhenNil(t *testing.T) {
	t.Parallel()
...
// TestRunCompletedPayload_QueueFieldsRoundTrip verifies that when QueueID and
// QueueGroupIndex are set, JSON marshal/unmarshal preserves their values per
// QM-011, QM-012, and event-model.md §6.3.
func TestRunCompletedPayload_QueueFieldsRoundTrip(t *testing.T) {
	t.Parallel()

	p := runterminalFixtureCompleted(t)
	qid := runterminalFixtureQueueID()
	gidx := 2
	p.QueueID = &qid
...
// TestRunFailedPayload_QueueFieldsOmittedWhenNil verifies that when QueueID
// and QueueGroupIndex are nil the JSON output omits both keys per QM-011,
// QM-012, and event-model.md §6.3.
func TestRunFailedPayload_QueueFieldsOmittedWhenNil(t *testing.T) {
	t.Parallel()
...
// TestRunFailedPayload_QueueFieldsRoundTrip verifies that when QueueID and
// QueueGroupIndex are set, JSON marshal/unmarshal preserves their values per
// QM-011, QM-012, and event-model.md §6.3.
func TestRunFailedPayload_QueueFieldsRoundTrip(t *testing.T) {
	t.Parallel()
