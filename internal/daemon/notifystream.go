	...
	subs := []core.Subscription{
		{
			...
			EventPattern:  core.EventPattern{Types: map[string]struct{}{string(core.EventTypeRunStarted): {}}},
		...
		},
		{
			...
			ConsumerClass: core.ConsumerClassObserver,
			EventPattern:  core.EventPattern{Types: map[string]struct{}{string(core.EventTypeWorkspaceMergeStatus): {}}},
			OnPanic:       core.OnPanicRecoverAndLog,
		...
		},
		{
			...
			ConsumerClass: core.ConsumerClassObserver,
			EventPattern:  core.EventPattern{Types: map[string]struct{}{string(core.EventTypeRunCompleted): {}}},
			OnPanic:       core.OnPanicRecoverAndLog,
		...
		},
		{
			...
			ConsumerClass: core.ConsumerClassObserver,
			EventPattern:  core.EventPattern{Types: map[string]struct{}{string(core.EventTypeRunFailed): {}}},
			OnPanic:       core.OnPanicRecoverAndLog,
