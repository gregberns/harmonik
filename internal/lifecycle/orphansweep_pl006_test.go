...
// ──────────────────────────────────────────────────────────────────────────────
// DaemonOrphanSweepCompletedPayload.Valid — new fields
// ──────────────────────────────────────────────────────────────────────────────
...
func TestPL006_RunOrphanSweep_EmptyProjectDir(t *testing.T) {
	...
	cfg := OrphanSweepConfig{
		TmuxLister:    &pl006FixtureFakeTmuxLister{},
		TmuxKiller:    &pl006FixtureFakeTmuxKiller{},
		HandlerLister: &pl006FixtureFakeHandlerLister{},
		BrLister:      orphanSweepFixtureFakeLister(),
	}
...
func TestPL006_RunOrphanSweep_AllCounters(t *testing.T) {
	...
	lister := &pl006FixtureFakeTmuxLister{sessions: []string{tmuxSession}}
	killer := &pl006FixtureFakeTmuxKiller{}
	...
	startupSweepFixtureSeedReconciliationLock(t, projectDir, "run-all-counters", deadPID, false)
