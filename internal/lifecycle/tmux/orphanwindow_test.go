...
func (a *orphanWindowFixtureAdapter) SendKeysEnter(_ context.Context, _ string) error {
	return nil
}

// SendKeysQuit is a no-op stub to satisfy the [Adapter] interface.
func (a *orphanWindowFixtureAdapter) SendKeysQuit(_ context.Context, _ string) error {
	return nil
}
