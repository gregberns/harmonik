...
func TestCadenceFilterValid(t *testing.T) {
	...
	tests := []struct {
		...
		{"unknown value", CadenceFilter("weekly"), false},
		{"mixed case", CadenceFilter("Smoke"), false},
...
func TestCadenceFilterMarshalText(t *testing.T) {
	...
	tests := []struct {
		...
		{"unknown value", CadenceFilter("weekly"), "", true},
	}
...
func TestCadenceFilterUnmarshalText(t *testing.T) {
	...
	tests := []struct {
		...
		{"unknown rejected", "weekly", CadenceFilter(""), true},
