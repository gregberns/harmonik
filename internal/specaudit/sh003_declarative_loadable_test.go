...
var sh003FixtureSH003Heading = regexp.MustCompile(`^#### SH-003 —`)
var sh003FixtureAnySectionHeading = regexp.MustCompile(`^#{1,4} `)
var sh003FixtureTagsMechanism = regexp.MustCompile(`^Tags:.*\bmechanism\b`)
