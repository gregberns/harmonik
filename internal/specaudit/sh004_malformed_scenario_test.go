...
var sh004FixtureSH004Heading = regexp.MustCompile(`^#### SH-004 —`)
var sh004FixtureAnySectionHeading = regexp.MustCompile(`^#{1,4} `)
var sh004FixtureTagsMechanism = regexp.MustCompile(`^Tags:.*\bmechanism\b`)
