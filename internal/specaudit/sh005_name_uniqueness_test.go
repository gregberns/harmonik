...
var sh005FixtureSH005Heading = regexp.MustCompile(`^#### SH-005 —`)
var sh005FixtureAnySectionHeading = regexp.MustCompile(`^#{1,4} `)
var sh005FixtureTagsMechanism = regexp.MustCompile(`^Tags:.*\bmechanism\b`)
