...
var (
	sh006FixtureSH006Heading      = regexp.MustCompile(`^#### SH-006 —`)
	sh006FixtureAnySectionHeading = regexp.MustCompile(`^#{1,4} `)
	sh006FixtureTagsMechanism     = regexp.MustCompile(`^Tags:.*\bmechanism\b`)
)
