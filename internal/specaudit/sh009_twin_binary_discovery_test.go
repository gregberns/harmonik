...
var (
	sh009FixtureSH009Heading      = regexp.MustCompile(`^#### SH-009 —`)
	sh009FixtureAnySectionHeading = regexp.MustCompile(`^#{1,4} `)
	sh009FixtureTagsMechanism     = regexp.MustCompile(`^Tags:.*\bmechanism\b`)
)
