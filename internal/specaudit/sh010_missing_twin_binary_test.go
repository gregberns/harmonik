...
var sh010FixtureSH010Heading = regexp.MustCompile(`^#### SH-010 —`)
var sh010FixtureAnySectionHeading = regexp.MustCompile(`^#{1,4} `)
var sh010FixtureTagsMechanism = regexp.MustCompile(`^Tags:.*\bmechanism\b`)
