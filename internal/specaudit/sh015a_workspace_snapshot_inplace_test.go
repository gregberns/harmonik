...
var sh015aFixtureSH015aHeading = regexp.MustCompile(`^#### SH-015a —`)
var sh015aFixtureAnySectionHeading = regexp.MustCompile(`^#{1,4} `)
var sh015aFixtureTagsMechanism = regexp.MustCompile(`^Tags:.*\bmechanism\b`)
