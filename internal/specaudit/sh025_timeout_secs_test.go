...
var sh025FixtureSH025Heading = regexp.MustCompile(`^#### SH-025 —`)
var sh025FixtureAnySectionHeading = regexp.MustCompile(`^#{1,4} `)
var sh025FixtureTagsMechanism = regexp.MustCompile(`^Tags:.*\bmechanism\b`)
