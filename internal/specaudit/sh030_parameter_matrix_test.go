...
var sh030FixtureSH030Heading = regexp.MustCompile(`^#### SH-030 —`)
var sh030FixtureAnySectionHeading = regexp.MustCompile(`^#{1,4} `)
var sh030FixtureTagsMechanism = regexp.MustCompile(`^Tags:.*\bmechanism\b`)
