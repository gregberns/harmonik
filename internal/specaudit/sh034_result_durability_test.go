...
var (
	sh034FixtureSH034Heading      = regexp.MustCompile(`^#### SH-034 —`)
	sh034FixtureAnySectionHeading = regexp.MustCompile(`^#{1,4} `)
	sh034FixtureTagsMechanism     = regexp.MustCompile(`^Tags:.*\bmechanism\b`)
)
