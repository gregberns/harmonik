...
#### PL-018 — Hook-bridge relay subprocesses are grandchildren of the daemon
...
(c) The relay's daemon-socket connection regime is governed by [handler-contract.md §4.10 HC-054] (one-shot NDJSON connections, each independent), NOT by HC-007's long-lived-stream model.

Tags: mechanism

(NOTE: re-using ID PL-018 collides with the existing PL-018 in §4.6 "Daemon is a deterministic Go binary." Renumbering required. **Use PL-017a or PL-019a (whichever the integration pass finds is the first unallocated number after PL-017).** Final ID is integration-pass-assigned; placeholder here.)

## Revision-history entry

| 2026-05-12 | 0.4.2 | foundation-author | Add new requirement in §4.5 (ID to be assigned at integration; placeholder PL-017a / PL-019a) clarifying that hook-bridge relay subprocesses spawned by an agent subprocess are grandchildren of the daemon and not subject to PL-014, PL-014a, or PL-006. Companion to [claude-hook-bridge.md] new spec. No prior IDs renumbered. Status remains `reviewed`. |
