...
**Re-measured 2026-07-30 with `wc -l`. Rank 1 is gone and three other sizes moved.**

| # | File | LOC | Commits | Longest function | Mutable globals | External world |
|---|---|---:|---:|---|---:|---|
| ~~1~~ | ~~`internal/daemon/reviewloop.go`~~ | **DELETED** | — | — | — | `3cec5afd7`, 2026-07-28 |
| 2 | `internal/daemon/dot_cascade_core.go` | 1,653 (was 1,989) | 123† | `driveDotWorkflow` **997** (+`dispatchDotAgenticNode` **543**, was 882) | 0 | tmux, claude, codex, git, ssh, fs, bus |
...
Runners-up: `internal/daemon/dot_gate.go` (749, was 888; `executeCognitionGate` 367),
...
**Revised 2026-07-30. The rewrite unit is now two files, not three.** `reviewloop.go` is deleted, so
the argument below applies to `dot_cascade_core.go` alone.
