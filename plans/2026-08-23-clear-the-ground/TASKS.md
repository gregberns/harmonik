...
Last updated 2026-08-23. Batches 1, 2, 4 and 5 written. Batch 3 (the four daemon extractions from the
...
| 2 | [`lint-rekey-exclusion-list`](tasks/lint-rekey-exclusion-list.md) | P0 | W1 | `hk-lint-rekey-exclusion-list-gfry7` | Blocks six other tasks. Nothing structural starts until this lands. |
| 3 | [`dispatch-activation-guard`](tasks/dispatch-activation-guard.md) | P0 | W1 | `hk-dispatch-activation-guard-atfwr` | Cheap, and the thing it prevents can permanently wedge restart. |
...
| 5 | [`structural-scoreboard`](tasks/structural-scoreboard.md) | P1 | W1 | `hk-structural-scoreboard-7o2u2` | Without it, this program cannot tell real progress from a comment deletion. |
...
| 19 | [`cli-extract-logic`](tasks/cli-extract-logic.md) | P1 | W4 | `hk-cli-extract-logic-aie1g` | `cli-structure-assessment` |
